...
namespace QuantityMeasurementApp.Model
{
  ...
  public sealed class Quantity<U> where U : Enum
  {
    ...
    private double PerformArithmeticOperation(Quantity<U> other, ArithmeticOperation operation)
    {
      ...
      return operation switch
      {
        ...
        ArithmeticOperation.Divide => Math.Abs(baseValue2) < Tolerance
         ? throw new InvalidOperationException("Cannot divide by zero") : baseValue1 / baseValue2,
    ...
    private double ConvertFromBaseToTarget(U targetUnit, double value)
    {
      ...
      {
        return TemperatureUnitConverter.ConvertFromBase(t, value);
      }
      else
      {
    ...
    private double ToBase()
    {
      ...
      {
        return TemperatureUnitConverter.ConvertToBase(t, Value);
      }
    ...
    {
      double result = PerformArithmeticOperation(other, ArithmeticOperation.Divide);
      return result;
    }
    ...
    public override string ToString()
    {
      ...
      {
        symbol = TemperatureUnitConverter.GetSymbol(t);
      }
