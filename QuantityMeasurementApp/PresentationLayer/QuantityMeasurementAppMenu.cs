...
namespace QuantityMeasurementApp.PresentationLayer
{
  ...
  public sealed class QuantityMeasurementAppMenu : IQuantityMeasurementAppMenu
  {
    ...
    private void ShowConversionHistory()
    {
      ...
      {
        if (entity.Operation == "Convert")
        {
          Console.WriteLine(
            $"{entity.Value1} {entity.Unit1} -> {entity.ResultValue} {entity.ResultUnit} at {entity.CreatedAt}"
          );
        }
        else
        {
          Console.WriteLine(
            $"{entity.Operation}: {entity.Value1} {entity.Unit1} and {entity.Value2} {entity.Unit2} = {entity.ResultValue} {entity.ResultUnit} at {entity.CreatedAt}"
          );
        }
      }
    }
