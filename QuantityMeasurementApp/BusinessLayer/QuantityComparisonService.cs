...
namespace QuantityMeasurementApp.BusinessLayer
{
  ...
  public class QuantityComparisonService
  {
    ...
    public Quantity<U> DemonstrateSubtraction<U>(Quantity<U> q1, Quantity<U> q2) where U : Enum
    {
      return q1.Add(q2);
    }

    public Quantity<U> DemonstrateSubtraction<U>(Quantity<U> q1, Quantity<U> q2, U targetUnit) where U : Enum
    {
      return q1.Add(q2, targetUnit);
    }

    public double DemonstarteDivision<U>(Quantity<U> q1, Quantity<U> q2) where U : Enum
    {
      return q1.Divide(q2);
    }
  }
