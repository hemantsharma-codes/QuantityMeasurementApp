...
namespace QuantityMeasurementAppTest.Tests
{
  ...
  public class TemperatureMeasurementTests
  {
    ...
    {
      var firstTemperature = new Quantity<TemperatureUnit>(0.0, TemperatureUnit.Celsius);
      var secondTemperature = new Quantity<TemperatureUnit>(0.0, TemperatureUnit.Celsius);
    ...
    {
      var firstTemperature = new Quantity<TemperatureUnit>(32.0, TemperatureUnit.Fahrenheit);
      var secondTemperature = new Quantity<TemperatureUnit>(32.0, TemperatureUnit.Fahrenheit);
    ...
    {
      var temperatureInCelsius = new Quantity<TemperatureUnit>(0.0, TemperatureUnit.Celsius);
      var temperatureInFahrenheit = new Quantity<TemperatureUnit>(32.0, TemperatureUnit.Fahrenheit);
    ...
    {
      var temperature = new Quantity<TemperatureUnit>(celsiusValue, TemperatureUnit.Celsius);

      var convertedTemperature = temperature.ConvertTo(TemperatureUnit.Fahrenheit);
    ...
    {
      var temperature = new Quantity<TemperatureUnit>(fahrenheitValue, TemperatureUnit.Fahrenheit);

      var convertedTemperature = temperature.ConvertTo(TemperatureUnit.Celsius);
    ...
    public void ConvertTo_WhenConvertedToAnotherUnitAndBack_ShouldPreserveOriginalValue()
    {
      ...
      var temperature = new Quantity<TemperatureUnit>(originalTemperature, TemperatureUnit.Fahrenheit);

      var convertedToCelsius = temperature.ConvertTo(TemperatureUnit.Celsius);
      var convertedBackToFahrenheit = convertedToCelsius.ConvertTo(TemperatureUnit.Fahrenheit);
    ...
    {
      var firstTemperature = new Quantity<TemperatureUnit>(100.0, TemperatureUnit.Celsius);
      var secondTemperature = new Quantity<TemperatureUnit>(50.0, TemperatureUnit.Celsius);
    ...
    /// <summary>
    /// Verifies division operation is not supported for temperature measurements.
    /// </summary>
    [TestMethod]
    public void Divide_WhenTemperatureDivisionAttempted_ShouldThrowInvalidOperationException()
    {
      var firstTemperature = new Quantity<TemperatureUnit>(100.0, TemperatureUnit.Celsius);
      var secondTemperature = new Quantity<TemperatureUnit>(0, TemperatureUnit.Celsius);
    ...
    {
      Assert.AreEqual("°C", TemperatureUnitConverter.GetSymbol(TemperatureUnit.Celsius));
      Assert.AreEqual("°F", TemperatureUnitConverter.GetSymbol(TemperatureUnit.Fahrenheit));
    }
  }
}