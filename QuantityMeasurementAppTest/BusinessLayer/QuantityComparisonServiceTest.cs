...
namespace QuantityMeasurementAppTest.BusinessLayer
{
    ...
    public sealed class QuantityComparisonServiceTest
    {
        ...
        /// </summary>
        [TestMethod]
        public void DemonstrateQuantityAddition_WithTargetUnitInches_ReturnsCorrectSum()
        {
            Quantity q1 = new Quantity(1, QuantityType.Feet);   // 12 inches
            Quantity q2 = new Quantity(12, QuantityType.Inches);

            Quantity result = _service.DemonstrateQuantityAddition(q1, q2, QuantityType.Inches);
